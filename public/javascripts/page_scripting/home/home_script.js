      ...
      if(http.responseText=="404"){
         ...
         comments = JSON.parse(http.responseText);
          ...
          for ( i = 0;i <=  comments.length - 1; i++) {
            ...
            newComments += 
            "<div class=\"well background_comment_color\" style=\"padding:10px 15px 10px 15px; margin-bottom:0px\"> "+
            "<div class=\"row\">"+
            ...
            "</div>"+
            "<div class=\"row col-sm-11\"  style=\"padding: 0 0 0px 0px; float:right\" > <div class=\"col-sm-11 pull-left\" style=\"padding: 0 0 0px 0px; margin: 0 0 0px 0px\">"+
            "<a href=\"/profile/"+
            ...
            if(comments[i].creator.email == myEmail){
              ...
              newComments += "<div class=\"col-sm-1 \" style=\"margin-top: float: right; 0px;padding-right: 0px;padding-top: 0px; padding-left: 0px;\">"+
            ...
            newComments += "</div><div class=\"col-sm-5 pull-left posting_time\" style=\"padding: 0 0 0px 0px; overflow-wrap: break-word; "+
            "margin: 0 0 0 10px\">"+
            calculateDiff(new Date(comments[i].date_created))+"</div>"

            newComments += "<div class=\"col-sm-12 pull-left\" style=\"padding: 5px 0 0px 0px; overflow-wrap: break-word; "+
            "margin: 0 0 0 0px\">"+
      ...
      if(http.responseText=="404"){
         ...
         likes = JSON.parse(http.responseText);
          ...
          for ( i = 0;i <=likes.length - 1; i++) {
            ...
            newLike += "<div class=\"col-sm-5 pull-left posting_time\" style=\"padding: 0 0 0px 0px; overflow-wrap: break-word; "+
            "margin: 0 0 0 10px\">"+
             calculateDiff(new Date(likes[i].date_created))+"</div>"+
            "</div>"+
            "</div>"+
            "</div>";
