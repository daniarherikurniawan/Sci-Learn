...
function hideComments(id2){
 ...
 $(buttonOnClick).css("color", "darkgrey");
      ...
      if(http.responseText=="404"){
         ...
         comments = JSON.parse(http.responseText);
          ...
          for ( i = 0;i <=  comments.length - 1; i++) {
            ...
            "-webkit-transform: translateY(-50%) translateX(-50%); \"src=\"/images/"+
            ...
            if(comments[i].creator.email == myEmail){
              ...
              "<li><a class=\"btn \" type=\"button\" onclick=\"editComment('"+comments[i]._id+"','"+post_id+"')\"><i "+"class=\"glyphicon glyphicon-pencil\" style=\"font-size:12px; color:black\"  ></i>&nbsp; Edit</a></li>"+
              "<li>"+
              " <a class=\"btn\" type=\"button\" onclick=\"tryToDeleteComment('"+comments[i]._id+"','"+post_id+"')\"><i "+"class=\"glyphicon glyphicon-remove \"  style=\"font-size:12px; color:black\"></i>&nbsp; "+"Delete</a></li>"+
              "</ul>"+
              " </li>"+
              "</div>";
            }
          ...
          $(buttonOnClick).css("color", "#3B5999");
          idd="showComment"+id3;
...
function normalizeButton(id3){
   ...
   $('#buttonLike'+id3).css('color','darkgrey');
    $('#buttonLike'+id3).attr('onClick',"showLikes('"+id3+"')");
   $('#buttonShare'+id3).css('color','darkgrey');
    $('#buttonShare'+id3).attr('onClick',"showShares('"+id3+"')");
   $('#button'+id3).css('color','darkgrey');
